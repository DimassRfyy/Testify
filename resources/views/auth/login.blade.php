    ...
    <section id="signup" class="flex w-full min-h-[832px]">
        ...
        <div class="left-side min-h-screen flex flex-col w-full pb-[30px] pt-[82px]">
            <div class="h-full w-full flex items-center justify-center">
                <form method="POST" action="{{ route('login') }}" class="flex flex-col gap-[30px] w-[750px] shrink-0">
                    @csrf
                    <h1 class="font-bold text-2xl text-center leading-9">Sign In</h1>
                    ...
                    <button type="submit"
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <a href="{{ route('socialiteRedirect', 'facebook') }}"
                                class="w-full max-w-xs font-bold shadow-sm rounded-lg py-3 bg-indigo-100 text-gray-800 flex items-center justify-center transition-all duration-300 ease-in-out focus:outline-none hover:shadow focus:shadow-sm focus:shadow-outline">
                                <div class="bg-white p-2 rounded-full">
                                    <svg class="w-4" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"  viewBox="0 0 48 48">
                            ...
                            <a href="{{ route('socialiteRedirect', 'github') }}"
                                class="w-full max-w-xs font-bold shadow-sm rounded-lg py-3 bg-indigo-100 text-gray-800 flex items-center justify-center transition-all duration-300 ease-in-out focus:outline-none hover:shadow focus:shadow-sm focus:shadow-outline">
        ...
        <div class="right-side min-h-screen flex flex-col w-[650px] shrink-0 pb-[30px] pt-[82px] bg-[#6436F1]">
            <div class="h-full w-full flex flex-col items-center justify-center pt-[66px] gap-[100px]">
                <div class="w-[500px] h-[360px] flex shrink-0 overflow-hidden">
                    <img src="{{asset('images/thumbnail/ilustration-3.svg')}}" class="w-full h-full object-contain"
                        alt="banner">
                </div>
